...
void Q2::SymmDifference()
{
    ...
    Intersection(); // got intersection in inter;
    cout << "{ ";
    for (int i = 0; i < l3; i++)
    {
        bool f = false;
...
void Q2::Difference()
{
    cout << "Set Difference of A-B: " << endl;
    cout << "{";
    for (int i = 0; i < l1; i++)
    {
        bool f = false;
    ...
    cout << "}" << endl;
    cout << endl;
    cout << "Set Difference of B-A: " << endl;
    cout << "{";
    for (int i = 0; i < l2; i++)
    {
        bool f = false;
...
int main()
{
    ...
    while (true)
    {
        cout << "1 to check subset, 2 to Find Union, 3 to check Intersection, 4 to find Complement, 5 for set difference,  6 for Symm difference  and 0 to end program" << endl;
        int c = 0;
        cin >> c;
        if (c == 1)
            ob.subset();
